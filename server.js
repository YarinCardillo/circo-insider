...
const WORDS = [
  ...
  'Clown', 'Pagliaccio', 'Domatore', 'Equilibrista', 'Acrobata',
  'Trapezista', 'Giocoliere', 'Naso rosso', 'Palloncini', 'Popcorn',
  'Zucchero filato', 'Arena', 'Applausi', 'Salto mortale', 'Cerchi di fuoco',
  'Sega umana', 'Cannone umano', 'Monociclo', 'Palline da giocoliere',
  'Clavette', 'Torce infuocate', 'Cappello a cilindro', 'Bacchetta magica',
  'Coniglio nel cappello', 'Mago', 'Illusionista', 'Levitazione',
  'Elefante', 'Leone', 'Tigre', 'Foca ammaestrata', 'Scimmia',
  'Cavallo bianco', 'Corda tesa', 'Rullo', 'Piramide umana',
  'Lancio dei coltelli', 'Donna barbuta', 'Uomo scheletro', 'Gigante',
  // Varie divertenti
